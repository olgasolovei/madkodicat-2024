...
1. **Ідентифікатор та назва**: UC-2.2 Аналітика даних безпеки
1. **Автор**: Зоть Вікторович Всевладний
1. **Дата створення**: 2024-11-04
1. **Основна дійова особа**: Керівник ділянки (Менеджер безпеки)
1. **Додаткова дійова особа**: Система моніторингу

1. **Опис**: Керівник отримує звіти про інциденти та загрози на майданчику для подальшого аналізу.
1. **Тригер**: Завершення робочого дня або тижня.
1. **Попередні умови**: Система має зібрані дані про інциденти.
- **Нормальний напрямок подій**:
...
1. **Альтернативний напрямок подій**:  
      2.a. Якщо дані недоступні, система надає попередження про відсутність даних.
1. **Винятки**: Технічні збої в зборі даних.
1. **Частота використання**: Раз на тиждень.
1. **Бізнес правила**: Звіти повинні формуватися в певний термін.
1. **Спеціальні вимоги**: Звіт повинен бути у зрозумілому форматі для аналізу.
1. **Припущення**: Дані зібрані без помилок.
